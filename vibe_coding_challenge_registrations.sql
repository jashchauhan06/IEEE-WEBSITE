-- Create a separate table for VIBE COADING CHALLENGE registrations
-- This table is specifically designed for the coding challenge event - TEAM BASED (3 members)

CREATE TABLE IF NOT EXISTS vibe_coding_challenge_registrations (
...
CREATE INDEX IF NOT EXISTS idx_vibe_registrations_team_name ON vibe_coding_challenge_registrations(team_name);
CREATE INDEX IF NOT EXISTS idx_vibe_registrations_leader_email ON vibe_coding_challenge_registrations(leader_email);
CREATE INDEX IF NOT EXISTS idx_vibe_registrations_status ON vibe_coding_challenge_registrations(registration_status);
CREATE INDEX IF NOT EXISTS idx_vibe_registrations_created_at ON vibe_coding_challenge_registrations(created_at);
CREATE INDEX IF NOT EXISTS idx_vibe_registrations_leader_semester ON vibe_coding_challenge_registrations(leader_semester);
...
COMMENT ON TABLE vibe_coding_challenge_registrations IS 'Registrations specifically for VIBE COADING CHALLENGE event - First Year Students Only (Team of 2-3 members)';
...
-- ) VALUES (
--     'Code Warriors', 'John Doe', '+91-9876543210', 'john.doe@example.com', 1, 'A', 'SIT2024001',
--     'Jane Smith', '+91-9876543211', 'jane.smith@example.com', 1, 'A', 'SIT2024002',
--     'Bob Johnson', '+91-9876543212', 'bob.johnson@example.com', 1, 'A', 'SIT2024003',
--     ARRAY['Python', 'Java', 'C++'], 'We want to improve our coding skills and learn from experienced developers', 'Pending'
-- );
